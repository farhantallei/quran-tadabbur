...
const Ayah = ({ currentAyahIndex, ayahData, rukuIndex, ayahIndex, setRukuIndex, setAyahIndex }) => {
    const handleAyahEdit = () => {
    ...
    return (
        <div className="card-ayah">
            <div className="card-ayah-action">
                <div className='index'>{currentAyahIndex(rukuIndex, ayahIndex)}</div>
                <button className='card-ayah-edit' onClick={handleAyahEdit}><svg xmlns="http://www.w3.org/2000/svg" fill="#c7c7cc" viewBox="0 0 30 12"><circle cx="3.5" cy="6" r="3.5"/><circle cx="26.5" cy="6" r="3.5"/><circle cx="15" cy="6" r="3.5"/></svg></button>
            </div>
